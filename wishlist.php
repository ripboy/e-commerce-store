...
<a align="center" href="/index.php">FURNISHCHEAP</a>
	...
	<div class="main_wrapper">
		...
		<div class="content_wrapper">
			...
			<div id="shopping_cart">
					...
					<b style="color:black">Shopping Cart </b>&nbsp;&nbsp;Total Items:&nbsp;<?php total_items();?>&nbsp;&nbsp;Total Price:&nbsp;<?php total_price(); ?>&nbsp;&nbsp;<a href="index.php" style="color:black">Back to Shop</a>&nbsp;&nbsp;
			...
			$total += $values;
					...
					<tr align="center">
						...
						if(isset($_POST['update_wishlist'])){
							...
							$update_qty = "update wishlist set qty='$qty'";
				...
				<?php } } ?>
					...
					<tr align="center">
						<td colspan="2"><input id="button" type="submit" name="update_wishlist" value="Update Wishlist"/></td>
	...
	function updateWishlist(){
		...
		if(isset($_POST['update_wishlist'])){
			...
			$delete_product = "delete from wishlist where p_id='$remove_id' AND ip_add='$ip'";
	...
	echo @$up_wishlist = updateWishlist();
