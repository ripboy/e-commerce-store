	...
	while($row_pro=mysqli_fetch_array($run_pro)){
		...
		echo "
				<div id='single_product_review'>
					...
					<a href='index.php?pro_id=$pro_id'><button id='button' style='float:right'>Add to Cart</button></a>
					...
					<p><b>Quality Team Review</b></p>
					<?php
                  			$get_review = "select review from reviews where p_id='$product_id'";
					...
					<br>
              				...
              				<p><b>Quality Team Rating</b></p>
              				
              				<?php
                 		 	$get_rating = "select rating from reviews where p_id='$product_id'";
                  			$run_rating = mysqli_query($con, $get_rating);

                 		 	while($rating_row = mysqli_fetch_array($run_rating)) {
