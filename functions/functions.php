	...
	while($row_pro=mysqli_fetch_array($run_pro)){
		...
		echo "
				<div id='single_product'>
					...
					<a style='float:left; color:#D3B396;' href='details.php?pro_id=$pro_id' style='float:left;'>Details</a>
					
					<a href='index.php?add_cart=$pro_id'><button id='button' style='float:right'>Cart</button></a>
