...
<?php 
		...
		while($p_price=mysqli_fetch_array($run_price)){
			...
			$invoice = mt_rand();
				...
				$remove_product = "delete from products where product_id ='$pro_id'";
				$run_remove = mysqli_query($con,$remove_product);
				
		if($amount==$total){
		
		echo "<h2>Welcome:" . $_SESSION['customer_email']. "<br>" . "Your Payment was successful!</h2>";
		echo "<a href='http://ashutosh.thecompletewebhosting.com/customer/my_account.php'>Go to your Account</a>";
		
		}
		else {
		
		echo "<h2>Welcome Guest, Payment was failed</h2><br>";
		echo "<a href='http://ashutosh.thecompletewebhosting.com/'>Go to Back to shop</a>";
			...
			$headers .= 'From: <sales@furnishcheap.com>' . "\r\n";
			...
			Hello dear <b style='color:blue;'>$c_name</b> you have ordered some products on our website furnishcheap.com, please find your order details, your order will be processed shortly. Thank you!</p>
			
				<table width='600' align='center' bgcolor='#FFCC99' border='2'>
			
					<tr align='center'><td colspan='6'><h2>Your Order Details from furnishcheap.com</h2></td></tr>
				...
				<h2> <a href='http://ashutosh.thecompletewebhosting.com'>Click here</a> to login to your account</h2>
				
				<h3> Thank you for your order @ - www.furnishcheap.com</h3>
